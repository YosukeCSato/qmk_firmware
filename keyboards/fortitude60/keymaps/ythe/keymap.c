 ...
 * | Shift|   Z  |   X  |   C  |   V  |   B  |   [  |   ]  |   N  |   M  |   ,  |   .  |   /  |   -  |
 * `-------------+------+------+------+------+------+------+------+------+------+------+-------------'
 *               |  Alt |  GUI |Lower |Space | Ctrl |Enter |   =  |Raise |  GUI |  Alt |
 *               `---------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT( \
  ...
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC, KC_RBRC, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_MINS , \
                 KC_LALT, KC_LGUI,   LOWER,  KC_SPC, KC_LCTL,  KC_ENT, KC_EQL, RAISE,    KC_RGUI, KC_RALT\
),
...
[_LOWER] = LAYOUT( \
  ...
  _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  _______, _______, KC_F12,S(KC_NUHS),S(KC_NUBS),_______, _______, KC_UNDS ,\
...
[_RAISE] = LAYOUT( \
  ...
  KC_DEL,  KC_LEFT, KC_DOWN, KC_RGHT, KC_F4,   KC_F5,                      KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_BSLS, KC_PIPE, \
